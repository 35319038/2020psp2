...
[comment #20200527宮下]
前回の修正点を確認しました。良くなっていると思います。
- 細かいところだと出力結果がソースコードと異なっています。
  - l.56では`L_A:0.000006`となってしまいます。
  - レポートのように`Likelihood for A:0.000006`となるように修正をお願いします。
k02完了としますが上の修正だけお願いします！

[comment #20200624 kotaro]
- 課題2の完了を確認しました．宮下さんのコメントについては修正しておいてください．
